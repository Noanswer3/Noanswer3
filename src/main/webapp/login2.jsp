...
<div class="login_window">
	<a href="healing.jsp"><h1 class="loginPage__title"><img src="img/logo.png" style="top: 8vw; right: 43vw; position: absolute; opacity: 1.0; width: 320px;"></h1></a>
	<div class="login_page">
		<form action="LoginCon2" method="post">
