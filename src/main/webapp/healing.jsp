   ...
   <main>
         ...
         <div class="meta">
            <div class="meta__links">
               <!-- <a href="login.jsp"
                  ...
                  <a href="login.jsp" style ="margin: 0 0 0 400px;"> # 로그인</a>
               </a> -->
                <!-- <a href="login.jsp" style="width:80px; height:60px; margin :0 0 0 530px; font-size:35px ; font-family: 'Nanum Pen Script', cursive;"> #로그인 </a> --> 
 				
 				<%if(id!=null){ %>
				<a href="DeleteCon" style="width:80px; height:60px; margin :0 0 0 530px; font-size:35px ; font-family: 'Nanum Pen Script', cursive;">로그아웃</a>
				<% }else{%>
				<a href="login2.jsp" style="width:80px; height:60px; margin :0 0 0 530px; font-size:35px ; font-family: 'Nanum Pen Script', cursive;">로그인</a>
				<%} %>
    ...
    width: 700px;">
               <a href="index_hanok.html" 
                  style="font-size: 40px; color: #492F10; font-family: 'Nanum Pen Script', cursive;">#한옥스테이</a>
               <a href="index_couple.html" class="meta__demo"
                  style="font-size: 40px; font-family: 'Nanum Pen Script', cursive;">#커플숙소</a>
               <a href="index_gamsung.html" class="meta__demo"
                  style="font-size: 40px; font-family: 'Nanum Pen Script', cursive;">#감성숙소</a>

               <a href="index_pool.html" class="meta__demo"
                  style="font-size: 40px; font-family: 'Nanum Pen Script', cursive;">#풀빌라
               </a><a href="index_healing.html" class="meta__demo meta__demo--current" class="meta__demo"
                  style="font-size: 40px; font-family: 'Nanum Pen Script', cursive;">#힐링숙소</a>
         ...
         <div class="content content--full content--alternate">
            <div class="content__item content__item--wide">
               ...
               <h2 class="content__item-title">유유자적<pre style="margin: 0rem 2rem; font-size : 40px; font-family: 'Nanum Pen Script', cursive;">
            
   #춘천 #힐링                                                         <a href = "map.jsp">예약하기</a></h2>
               <p class="content__item-description">
               <!-- <pre class = "pre_item" style = "margin: 0rem 2rem;"> #춘천 #펜션</pre> -->
               </p>
            </div>
            <div class="content__item content__item--wide">
               ...
               <!-- <div class="content__item-deco"></div> -->
               <h2 class="content__item-title">여느날<pre style="margin: 0rem 2rem; font-size : 40px; font-family: 'Nanum Pen Script', cursive;">
            
   #서울 #힐링                                                         <a href = "map.jsp">예약하기</a></h2>
               <p class="content__item-description">
               <!-- <pre style = "margin: 0rem 2rem;">#서울 #펜션</pre> -->
               </p>
            </div>
            <div class="content__item content__item--wide">
               <div class="content__item-imgwrap">
               ...
               <!-- <div class="content__item-deco"></div> -->
               <h2 class="content__item-title">서림연가<pre style="margin: 0rem 2rem; font-size : 40px; font-family: 'Nanum Pen Script', cursive;">
            
   #무주 #힐링                                                         <a href ="map.jsp">예약하기</a></h2></h2>
               <p class="content__item-description">
               <!-- <pre style = "margin: 0rem 2rem;">#무주 #펜션</pre> -->
               </p>
            </div>
            <div class="content__item content__item--wide">
               <div class="content__item-imgwrap">
               ...
               <!-- <div class="content__item-deco"></div> -->
               <h2 class="content__item-title">켄싱턴 하동<pre style="margin: 0rem 2rem; font-size : 40px; font-family: 'Nanum Pen Script', cursive;">
            
   #하동 #힐링                                                         <a href = "map.jsp">예약하기</a></h2></h2>
               <p class="content__item-description">
               <!-- <pre style = "margin: 0rem 2rem;">#하동 #리조트</pre> -->
               </p>
            </div>
            <p class="credits">
